     ...
     <form style="margin-left:35%; margin-top: 5%;" wire:submit="yanitEkle">
         <div style="background-color:#f2f2f2; display:inline-block;" class="p-3">
             ...
             <div class="mb-3 mt-3">
                 ...
                 <input type="radio" name="secenek" wire:model="secenek_id" value="{{ $anketSecenek->id }}" >{{ $anketSecenek->secenek }}
             ...
             <div class="mb-3 mt-3">
                 ...
                 <div>
                     <input type="radio" name="secenek2" wire:model="secenek_id" value="{{ $anketSecenek->id }}">{{ $anketSecenek->secenek }}
